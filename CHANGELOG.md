...
### Added
- `autoops preflight` reports now carry an explicit `schema_version` (`1`) in human, JSON, and CSV output, giving downstream CI/support tooling a stable compatibility marker as the report evolves.
